 ...
 */
var checkNodeVisible = function checkBoxVisible(node) {
...
var checkOverflowVisible = function checkOverflowVisible(component, parent) {
  ...
  var intersectionHeight = parentTop + parentHeight - intersectionTop; // height
...
var checkVisible = function checkVisible(component) {
  ...
  checkNodeVisible(node) && (isOverflow ? checkOverflowVisible(component, parent) : checkNormalVisible(component));
...
var purgePending = function purgePending(listeners) {
...
var lazyLoadHandler = function lazyLoadHandler(listeners) {
  return function () {
...
var finalLazyLoadHandlers = new Map();
  ...
  _createClass(LazyLoad, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.overflow) {
        parent = (0, _scrollParent2.default)(_reactDom2.default.findDOMNode(this));
        if (!parent) {
      ...
      var finalLazyLoadHandler = finalLazyLoadHandlers.get(parent);
      var listeners = listenerMap.get(parent);
      if (!listeners) {
        listeners = [];
      ...
      if (!finalLazyLoadHandler) {
        if (this.props.debounce !== undefined) {
          finalLazyLoadHandler = (0, _debounce2.default)(lazyLoadHandler(listeners), typeof this.props.debounce === 'number' ? this.props.debounce : 300);
          delayType = 'debounce';
        } else {
          finalLazyLoadHandler = (0, _throttle2.default)(lazyLoadHandler(listeners), typeof this.props.throttle === 'number' ? this.props.throttle : 300);
          delayType = 'throttle';
        }
...
var forceCheck = exports.forceCheck = function forceCheck() {
  listenerMap.forEach(function (listeners) {
